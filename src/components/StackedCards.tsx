          ...
          <div className="relative w-full h-full overflow-hidden">
            ...
            <div className="relative h-full rounded-3xl border-2 border-blue-500/30 bg-gradient-to-br from-slate-800/40 to-slate-900/40 backdrop-blur-sm overflow-hidden">
              ...
              <div className="relative h-full flex items-center bg-black">
                ...
                <div className="w-1/2 px-16 py-12 z-10">
                ...
                <div className="w-1/2 h-full relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative w-full h-full">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 via-blue-500/20 to-indigo-500/20 rounded-3xl m-8"></div>
                      ...
                      {/* Chrome icon badge */}
                      <div className="absolute bottom-16 left-1/2 -translate-x-1/2 flex items-center gap-3 bg-black/40 backdrop-blur-md px-6 py-3 rounded-full border border-cyan-400/30">
