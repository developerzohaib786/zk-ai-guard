...
import { Shield, Lock, Bot, Zap, Package, Eye } from 'lucide-react';
...
const FeaturesSection = () => {
  return (
    // Reusing the theme's background and structure
    <div className="min-h-screen bg-slate-950 relative overflow-hidden">
      ...
      <div className="relative z-10 flex py-10">
        <div className="w-full grid lg:grid-cols-2 gap-18 px-10">
          ...
          {/* Left Side: Lock Illustration (Replicating the image's left side) */}
          <div className="relative flex items-center justify-center lg:justify-start min-h-[400px]">
            ...
            <div className="relative z-10">
              {/* Outer Wireframe Effect (Simulated with div and box-shadow/border) */}
              <div className="relative w-64 h-80">
                
                {/* Lock body (Keyhole section) */}
            ...
            {/* Floating geometric shapes specific to the lock */}
          ...
          {/* Right Side: Features Title and Grid (Replicating the image's right side) */}
